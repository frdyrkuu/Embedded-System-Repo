...
<head>
    ...
    <title>
        Geolocation Map - Embedded System
    </title>
                ...
                <nav class="mt-5 px-4 py-4 lg:mt-9 lg:px-6" x-data="{selected: $persist('Dashboard')}">
                    ...
                    <div>
                        ...
                        <ul class="mb-6 flex flex-col gap-1.5">
                            ...
                            <li>
                                <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                                    href="#" @click.prevent="selected = (selected === 'Tables' ? '':'Tables')"
                        ...
                        <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                            <a class="flex items-center gap-4" href="#" @click.prevent="dropdownOpen = ! dropdownOpen">
                                <span class="hidden text-right lg:block">
                                    <span class="block text-sm font-medium text-black dark:text-white">Team Itik</span>
                                    <span class="block text-xs font-medium">Computer Engineeers</span>
                                </span>

                                <span class="h-20 w-20 rounded-full">
                                    <img src="assets/Donald_Duck-logo-A918488B6F-seeklogo.com-1628401375.png"
                                        alt="User" />
                                </span>
                    ...
                    <div class="rounded-sm border border-stroke bg-white px-7.5 py-6 shadow-default dark:border-strokedark dark:bg-boxdark">
                        <style>
                            ...
                            #myLocationButton {
                                ...
                                position: absolute;
                                bottom: 10px;
                                /* Place the button near the bottom of the map */
                                left: 50%;
                                /* Center horizontally */
                                transform: translateX(-50%);
                                /* Centering trick */
                                z-index: 1000;
                                /* Ensure button stays above the map */
                            }
                        ...
                        <h2 class="text-title-md font-bold text-black dark:text-white text-center">Geolocation Map</h2>
                        <br>
                        <div id="map">
