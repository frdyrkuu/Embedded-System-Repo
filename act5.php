...
<div class="grid grid-cols-2 gap-4 h-[400px] bg-white rounded-[8px] border-gray-200 shadow-sm p-4 py-8 w-full mt-4 mx-auto">
    <div>
        <canvas id="soundChart" width="9000" height="5000" class="mx-auto flex items-center justify-center"></canvas>
    </div>
    <div>
        <canvas id="rainChart" width="9000" height="5000" class="mx-auto flex items-center justify-center"></canvas>
    </div>
</div>
