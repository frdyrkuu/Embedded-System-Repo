...
const combinedCtx = document.getElementById('combinedDistanceChart').getContext('2d');
    ...
    data: {
        ...
        datasets: [
            ...
            },
            {
                ...
                fill: false,
                borderColor: 'rgb(0, 255, 0)', // Green for highest distance sensor 1
                borderWidth: 0, // No line
                pointRadius: 5, // Size of the dots
                pointBackgroundColor: 'rgb(0, 255, 0)' // Dot color
            },
            {
            ...
            },
            {
                ...
                data: [], // Empty data initially
                fill: false,
                borderColor: 'rgb(0, 255, 255)', // Cyan for highest distance sensor 2
                borderWidth: 0, // No line
                pointRadius: 5, // Size of the dots
                pointBackgroundColor: 'rgb(0, 255, 255)' // Dot color
            },
            {
                        ...
                        return original.map(label => {
                            ...
                            switch (dataset.label) {
                                ...
                                case 'Highest Distance Sensor 2 (cm)':
                                    label.textColor = 'rgb(0, 255, 255)'; // Cyan
                                    break;
